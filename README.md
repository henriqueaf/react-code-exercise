...
First you need to create a new file `.env` on project's `root` directory and put your credentials into it.
...
Now open your favorite browser on page: http://localhost:3000
